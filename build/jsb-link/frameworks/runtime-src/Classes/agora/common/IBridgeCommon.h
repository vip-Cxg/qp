...
enum API_TYPE {
  ...
  SWITCH_CHANNEL_2,
  SET_CLOUD_PROXY,
  START_AUDIO_RECORDING_3,
  ADJUST_LOOPBACK_RECORDING_SIGNAL_VOLUME,
  CREATE_DATA_STREAM_2,
  ENABLE_VIRTUAL_BACKGROUND,
  MUTE_LOCAL_AUDIO_STREAM_IN_CHANNEL,
  MUTE_LOCAL_VIDEO_STREAM_IN_CHANNEL
};
...
enum API_TYPE_AUDIO_EFFECT {
  ...
  START_AUDIO_MIXING_2,
  GET_AUDIO_MIXING_DURATION_2,
  PLAY_EFFECT_2,
  GET_EFFECT_DURATION,
  SET_EFFECT_POSITION,
  GET_EFFECT_CURRENT_POSITION,
  ENABLE_DEEPLEARNINGDENOISE,
  SET_VOICE_BEAUTIFIER_PRESET,
  SET_AUDIO_EFFECT_PRESET,
  SET_VOICE_CONVERSATION_PRESET,
  SET_AUDIO_EFFECT_PARAMETERS,
  SET_VOICE_BEAUTIFIER_PARAMETERS,
};
