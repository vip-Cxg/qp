...
@ccclass
export default class ProxyBuyTradeItem extends cc.Component {
    @property(cc.Label)
    lblDesc = null;
    @property(cc.Label)
    lblAmount = null;
    ...
    initData(data) {
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, () => {
            //选择交易方式
           let  typeItem=cc.instantiate(this.selectTradeType);
           typeItem.getComponent('SelectTradeType').initData(data);
           cc.find('Canvas').addChild(typeItem);
