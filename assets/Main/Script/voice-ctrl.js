...
let VoiceCtrl = cc.Class({
    ...
    prepare: function (filename) {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoiceRecorder", "prepare", "(Ljava/lang/String;)V", filename);
        }
    ...
    release: function () {
        ...
        cc.log("release");
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoiceRecorder", "release", "()V");
        }
        else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    cancel: function () {
        ...
        AudioCtrl.getInstance().resumeAll();
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoiceRecorder", "cancel", "()V");
        }
        else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    play: function (filename) {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoicePlayer", "play", "(Ljava/lang/String;)V", filename);
        }
        else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    stop: function () {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoicePlayer", "stop", "()V");
        }
        else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    setStorageDir: function (dir) {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("com/wuyouqp/voicesdk/VoiceRecorder", "setStorageDir", "(Ljava/lang/String;)V", dir);
        }
        else if (cc.sys.os == cc.sys.OS_IOS) {
